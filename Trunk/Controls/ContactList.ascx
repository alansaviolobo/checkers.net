<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ContactList.ascx.cs" Inherits="Controls_ContactList" %>
...
<div style="float: left; width: auto;">
    ...
    <asp:DataGrid ID="DgUser" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <asp:BoundColumn DataField="Contact_Phone" HeaderText="Phone"></asp:BoundColumn>
            <asp:BoundColumn DataField="Contact_OrganizationName" HeaderText="Organization Name"></asp:BoundColumn>
            <asp:BoundColumn DataField="Contact_OrganizationPhone" HeaderText="Organization Phone"></asp:BoundColumn>
