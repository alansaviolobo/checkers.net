...
USE [Checkers]
GO
/****** Object:  Table [dbo].[Sales]    Script Date: 01/11/2010 14:52:45 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Purchase]    Script Date: 01/11/2010 14:52:41 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Menu]    Script Date: 01/11/2010 14:52:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[InventoryDelete]    Script Date: 01/11/2010 14:51:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	END
GO
/****** Object:  Table [dbo].[Content]    Script Date: 01/11/2010 14:52:16 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Inventory]    Script Date: 01/11/2010 14:52:24 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[Token]    Script Date: 01/11/2010 14:52:51 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[Source]    Script Date: 01/11/2010 14:52:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[Package]    Script Date: 01/11/2010 14:52:34 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[PettyCash]    Script Date: 01/11/2010 14:52:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Catalog]    Script Date: 01/11/2010 14:52:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[Contact]    Script Date: 01/11/2010 14:52:14 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[Invoice]    Script Date: 01/11/2010 14:52:28 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Credit, Credit Card, Cash, Cheque, Zero Billing' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'Invoice', @level2type=N'COLUMN',@level2name=N'Invoice_PaymentMode'
GO
/****** Object:  Table [dbo].[Activity]    Script Date: 01/11/2010 14:52:07 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[PettyExpense]    Script Date: 01/11/2010 14:52:39 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[Converter]    Script Date: 01/11/2010 14:52:18 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[CatalogNew]    Script Date: 01/11/2010 14:51:46 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	END
GO
/****** Object:  StoredProcedure [dbo].[CatalogDelete]    Script Date: 01/11/2010 14:51:46 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	END
GO
/****** Object:  Table [dbo].[Event]    Script Date: 01/11/2010 14:52:20 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  StoredProcedure [dbo].[ContactDelete]    Script Date: 01/11/2010 14:51:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	END
GO
/****** Object:  StoredProcedure [dbo].[ContactEdit]    Script Date: 01/11/2010 14:51:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	BEGIN
		IF EXISTS(SELECT * FROM Contact WHERE (Contact_UserName = @UserName OR Contact_Phone = @Phone) AND Contact_Id != @Id)
			RETURN 0
		ELSE
			BEGIN
	...
	END
GO
/****** Object:  StoredProcedure [dbo].[MenuEdit]    Script Date: 01/11/2010 14:51:57 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	BEGIN
		IF EXISTS(SELECT * FROM Menu WHERE Menu_Name = @Name AND Menu_Id != @Id)
				RETURN 0
		ELSE
			BEGIN
				UPDATE Menu SET Menu_Name = @Name, Menu_Category = @Category, Menu_SellingPrice = @Price
				WHERE Menu_Id = @Id AND Menu_Status = 1
				RETURN 1
			END
	END
GO
/****** Object:  StoredProcedure [dbo].[MenuDelete]    Script Date: 01/11/2010 14:51:56 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	END
GO
/****** Object:  StoredProcedure [dbo].[PurchaseDelete]    Script Date: 01/11/2010 14:52:00 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	END
GO
/****** Object:  StoredProcedure [dbo].[InvoiceEdit]    Script Date: 01/11/2010 14:51:55 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	BEGIN
		UPDATE Invoice SET Invoice_Amount = @Amount, Invoice_Discount = @Discount, Invoice_Tax = @Tax, Invoice_Type = @Type, Invoice_PaymentMode = @PaymentMode
		WHERE Invoice_Id = @Id AND Invoice_Status = 1
		RETURN 1
	END
GO
/****** Object:  StoredProcedure [dbo].[InvoiceDelete]    Script Date: 01/11/2010 14:51:55 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	END
GO
/****** Object:  StoredProcedure [dbo].[InvoiceCloseCredit]    Script Date: 01/11/2010 14:51:54 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	UPDATE Contact SET Contact_Credit = @OldCredit + ( (@Amount - @Discount) + @Tax)
	...
	RETURN 1
GO
/****** Object:  StoredProcedure [dbo].[InvoiceCloseZeroBilling]    Script Date: 01/11/2010 14:51:54 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	RETURN 1
GO
/****** Object:  StoredProcedure [dbo].[InvoiceClose]    Script Date: 01/11/2010 14:51:53 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	RETURN 1
GO
/****** Object:  StoredProcedure [dbo].[SalesNew]    Script Date: 01/11/2010 14:52:03 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	END
GO
/****** Object:  StoredProcedure [dbo].[SalesEdit]    Script Date: 01/11/2010 14:52:03 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	END
GO
/****** Object:  StoredProcedure [dbo].[SalesDelete]    Script Date: 01/11/2010 14:52:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	BEGIN
		...
		WHERE Source_Id = @SourceId	
		UPDATE Token SET Token_Status = 0 
		WHERE Token_Menu = @Menu AND Token_Source = @Source AND Token_Status = 1
		RETURN 1
	END
GO
/****** Object:  StoredProcedure [dbo].[PurchaseNew]    Script Date: 01/11/2010 14:52:00 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	END
GO
/****** Object:  StoredProcedure [dbo].[PurchaseEdit]    Script Date: 01/11/2010 14:52:00 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	END
GO
/****** Object:  StoredProcedure [dbo].[MenuNew]    Script Date: 01/11/2010 14:51:57 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	BEGIN
		...
		ELSE
			BEGIN
				INSERT INTO Menu(Menu_Name, Menu_Category, Menu_SellingPrice, Menu_Status, Menu_TimeStamp)
				VALUES(@Name, @Category, @Price, 1, CURRENT_TIMESTAMP)
				RETURN 1
			END
	END
GO
/****** Object:  StoredProcedure [dbo].[SelectItemByType]    Script Date: 01/11/2010 14:52:04 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SpContent]    Script Date: 01/11/2010 14:52:04 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	IF(@Operation = 'New')
		BEGIN
			IF EXISTS(SELECT * FROM Content WHERE Content_Material = @Material AND Content_Package = @Package)
				SET @Result = 0
			ELSE
				BEGIN
					INSERT INTO Content(Content_Material, Content_Quantity, Content_UnitPrice, Content_Discount, Content_Cost, Content_Package, Content_Status) 
					VALUES(@Material, @Quantity, @UnitPrice, @Discount, @Cost, @Package, 1)
					SET @Result = 1
				END
		END
	ELSE IF(@Operation = 'Edit')
		BEGIN
			UPDATE Content SET Content_Material = @Material, Content_Quantity = @Quantity, Content_UnitPrice = @UnitPrice, Content_Discount = @Discount, Content_Cost = @Cost, Content_Package = @Package
	...
	RETURN @Result
GO
/****** Object:  StoredProcedure [dbo].[InventoryNew]    Script Date: 01/11/2010 14:51:53 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	ELSE
		BEGIN
			...
			VALUES(@Name, @BuyingPrice, @Threshold,0, @PurchaseUnit, @ConversionUnit, 1, CURRENT_TIMESTAMP)
			
			RETURN 1
		END
GO
/****** Object:  StoredProcedure [dbo].[InventoryEdit]    Script Date: 01/11/2010 14:51:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	ELSE
		BEGIN
			UPDATE Inventory SET Inventory_Name = @Name, Inventory_BuyingPrice =  @BuyingPrice, Inventory_Threshold = @Threshold, Inventory_PurchaseUnit = @PurchaseUnit, Inventory_ConversionUnit = @ConversionUnit
			WHERE Inventory_Id = @Id AND Inventory_Status = 1
			RETURN 1
		END
GO
/****** Object:  StoredProcedure [dbo].[InventorySubtract]    Script Date: 01/11/2010 14:51:53 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
 ...
 *
 * File Information: To be called when any sales order is placed  */
...
AS
	...
	RETURN 1
GO
/****** Object:  StoredProcedure [dbo].[InventoryAdd]    Script Date: 01/11/2010 14:51:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
 ...
 * Author: Agraj Agranayak
 *
 * File Information: To be called when any sales order is cancelled  */
...
AS
	...
	RETURN
GO
/****** Object:  StoredProcedure [dbo].[TokenNew]    Script Date: 01/11/2010 14:52:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	RETURN 1
GO
/****** Object:  StoredProcedure [dbo].[InvoiceNew]    Script Date: 01/11/2010 14:51:56 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	VALUES(@Amount, @Discount, @Tax, @Type, @Source, @PaymentMode, 1, CURRENT_TIMESTAMP)
	...
	RETURN 1
GO
/****** Object:  StoredProcedure [dbo].[PackageNew]    Script Date: 01/11/2010 14:51:58 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	ELSE
		...
		END
GO
/****** Object:  StoredProcedure [dbo].[PackageEdit]    Script Date: 01/11/2010 14:51:58 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	ELSE		
		...
		END
GO
/****** Object:  StoredProcedure [dbo].[PackageDelete]    Script Date: 01/11/2010 14:51:57 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	RETURN 1
GO
/****** Object:  StoredProcedure [dbo].[PettyCashNew]    Script Date: 01/11/2010 14:51:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS	
	...
	VALUES(@Amount, (@Amount + @Balance), @GivenBy, @ReceivedBy, CURRENT_TIMESTAMP)
	
	RETURN 1
GO
/****** Object:  StoredProcedure [dbo].[PettyExpenseNew]    Script Date: 01/11/2010 14:51:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	INSERT INTO PettyExpense(PettyExpense_Amount, PettyExpense_Merchandise, PettyExpense_Quantity, PettyExpense_ReceivedBy, PettyExpense_TimeStamp) 
	...
	RETURN 1
GO
/****** Object:  StoredProcedure [dbo].[CatalogEdit]    Script Date: 01/11/2010 14:51:46 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS	
	...
	ELSE
		...
		END
GO
/****** Object:  StoredProcedure [dbo].[ContactNew]    Script Date: 01/11/2010 14:51:49 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[ContactNew]
	...
	@OrganizationPhone VARCHAR(100)
AS
	IF EXISTS(SELECT * FROM Contact WHERE Contact_UserName = @UserName OR Contact_Phone = @Phone)
		RETURN 0
	ELSE
		BEGIN
			...
			VALUES(@Name, @UserName, @Password, @Type, @Phone, @Address, @Email, @OrganizationName, @OrganizationAddress, @OrganizationPhone, 0, 1, CURRENT_TIMESTAMP)
			RETURN 1
		END
GO
/****** Object:  StoredProcedure [dbo].[ReceiptNew]    Script Date: 01/11/2010 14:52:01 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[ReceiptNew] --default type=Receipt
	...
	@ClientId INT
AS
	INSERT INTO Invoice(Invoice_Amount, Invoice_Type, Invoice_PaymentMode, Invoice_Client, Invoice_Status, Invoice_TimeStamp)
	...
	RETURN 1
GO
/****** Object:  StoredProcedure [dbo].[ReceiptDelete]    Script Date: 01/11/2010 14:52:01 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	DECLARE @Amount DECIMAL(6, 2)
	SET @Amount = (SELECT Invoice_Amount FROM Invoice WHERE Invoice_Id = @Id AND Invoice_Status = 0)
	...
	RETURN 1
GO
/****** Object:  StoredProcedure [dbo].[ChangePassword]    Script Date: 01/11/2010 14:51:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	ELSE
		RETURN 0
GO
/****** Object:  StoredProcedure [dbo].[EventNew]    Script Date: 01/11/2010 14:51:51 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	ELSE
		BEGIN
			...
			VALUES(@Name, @From, @To, @Organizer, @Venue, 1, CURRENT_TIMESTAMP)
			RETURN 1
		END
GO
/****** Object:  StoredProcedure [dbo].[EventEdit]    Script Date: 01/11/2010 14:51:51 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	RETURN 1
GO
/****** Object:  StoredProcedure [dbo].[EventDelete]    Script Date: 01/11/2010 14:51:50 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	RETURN 1
GO
/****** Object:  StoredProcedure [dbo].[ActivityNew]    Script Date: 01/11/2010 14:51:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS	
	...
	Return 1
GO
/****** Object:  StoredProcedure [dbo].[ConverterNew]    Script Date: 01/11/2010 14:51:50 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	ELSE
		BEGIN
			...
			VALUES(@Menu, @Inventory, @InventoryQuantity, 1, CURRENT_TIMESTAMP)
			RETURN 1
		END
GO
/****** Object:  StoredProcedure [dbo].[ConverterEdit]    Script Date: 01/11/2010 14:51:49 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	ELSE
		...
		END
GO
/****** Object:  StoredProcedure [dbo].[ConverterDelete]    Script Date: 01/11/2010 14:51:49 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
IF NOT EXISTS (SELECT loginname FROM master.dbo.syslogins WHERE name = 'Checkers' AND dbname = 'Checkers')
BEGIN	
	CREATE LOGIN Checkers WITH PASSWORD = 'Checkers',DEFAULT_DATABASE=[Checkers], CHECK_EXPIRATION=OFF, CHECK_POLICY=OFF
